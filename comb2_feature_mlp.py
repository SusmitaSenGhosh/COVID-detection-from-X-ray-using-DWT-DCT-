...
for k in range(0,5):
    ...
    weight_path ='C:/Users/susmi/for_paper/output/dct_dwt/fold'+str(k+1)+'/mlp_weight/'
    intermediate_datafolder1 = 'C:/Users/susmi/for_paper/dct_intermediate_fold' +str(k+1)+'/'
    intermediate_datafolder2 = 'C:/Users/susmi/for_paper/dwt_intermediate_fold' +str(k+1)+'/'
    ...
    counter = counter + 12
wb.save('C:/Users/susmi/for_paper/output/dct_dwt/'+'result.xls') 
