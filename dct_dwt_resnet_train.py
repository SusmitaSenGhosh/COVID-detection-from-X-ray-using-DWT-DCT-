...
for k in range(1,5):
    ...
    preprocessed_image_path = 'C:/Users/susmi/for_paper/dct/'
    weight_path ='C:/Users/susmi/for_paper/output/dct/fold'+str(k+1)+'/'
    intermedite_output_path = 'C:/Users/susmi/for_paper/dct_intermediate_fold' +str(k+1)+'/'
    batch_size = 32 
    num_classes = 3
    epochs = 300
    input_size = 224
