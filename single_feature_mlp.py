...
for k in range(0,5):
    ...
    weight_path ='C:/Users/susmi/for_paper/output/dwt/fold'+str(k+1)+'/mlp_weight_50epoches/'
    intermediate_datafolder = 'C:/Users/susmi/for_paper/dwt_intermediate_fold' +str(k+1)+'/'
    batch_size = 32 
    num_classes = 3
    epochs = 50
    input_size = 224
    ...
    counter = counter + 12
wb.save('C:/Users/susmi/for_paper/output/dwt/'+'result_50.xls') 
